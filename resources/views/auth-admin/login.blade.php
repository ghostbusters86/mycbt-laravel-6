                        ...
                        <div class="login-form">
                            <form method="POST" action="{{ route('admin.loginSubmit') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="au-input au-input--full @error('email') is-invalid @enderror" name="email" type="email" placeholder="Email" value="{{ old('email') }}" required autocomplete="email" autofocus>
